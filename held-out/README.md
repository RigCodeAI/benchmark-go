...
Held-out evidence is deliberately not checked into this directory. The native
scorer accepts each signed projection with `--held-out-evidence` and refuses
promotion until three distinct repository identities close all 39 categories.
